...
/* Uses sys.fn_xe_file_target_read_file to read the files into a CTE in the form
   of a table with one row per event logged in XML format.
   Then uses the .VALUE function to get to individual nodes from each row.
*/   
